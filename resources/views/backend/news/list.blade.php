        ...
        <div class="m-portlet__head-tools">
            ...
            <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                    <a href="{{ route('news.create') }}" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
                        <span>
                        ...
                        <td nowrap="" align="center">
                            ...
                            <span class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    @can('post-edit')
                                        <a class="dropdown-item" href="{{ route('news.edit',$post->id) }}"><i class="la la-edit"></i> Edit </a>
                                    @endcan
                                    
                                    @can('post-delete')
                                        <a class="dropdown-item delItem" href="#{{route('news.destroy', $post->id)}}" data-delform="delete-form{{ $post->id }}"><i class="la la-trash"></i>Delete</a>
                                    {!! Form::open(['method' => 'DELETE','route' => ['news.destroy', $post->id],'style'=>'display:inline', 'id'=>'delete-form'.$post->id]) !!}
                                    {!! Form::close() !!}
                                    @endcan
