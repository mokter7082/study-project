        ...
        <div class="m-portlet m-portlet--tab"> 
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">{{ isset($post->id)?'Edit':'Create a new'}} blog</h3>
                    </div>
                </div>
            ...
            <div class="m-portlet__body">
                <div class="form-group {{ $errors->has('title') ? 'has-danger':'' }}"> 
                    ...
                    {!! Form::text('title',  $post->title??null, array('placeholder' => 'Blog Title *','class' => 'form-control m-input', 'id'=>'title')) !!} 
        ...
        <div class="m-portlet m-portlet--tab mb10">
            ...
            <div class="m-portlet__body right-bar">  
                <div class="form-group">
                    ...
                    {!! Form::select('category',$allCategories??[], $post->category??old('category'), ['class'=>'form-control c_selectpicker m-input', 'placeholder'=>'--choose category--', 'data-rel'=>'chosen']) !!} 
                </div>  
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('status', ['Active'=>'Active', 'Inactive'=>'Inactive'], $post->status??old('status'), ['class'=>'form-control c_selectpicker m-input', 'data-rel'=>'chosen']) !!} 
                </div> 
