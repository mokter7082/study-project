        ...
        <div class="m-portlet m-portlet--tab"> 
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text"><?php echo e(isset($post->id)?'Edit':'Neuen Beitrag erstellen'); ?> erstellen</h3>
                    </div>
                </div>
            ...
            <div class="m-portlet__body">
                <div class="form-group <?php echo e($errors->has('title') ? 'has-danger':''); ?>"> 
                    <?php echo Form::label('title', 'Beitragstitel *'); ?>

                    <?php echo Form::text('title',  $post->title??null, array('placeholder' => 'Beitragstitel *','class' => 'form-control m-input', 'id'=>'title')); ?> 
                ...
                <div class="row mt10">
                    <div class="col-md-12">
                        <div class="form-group <?php echo e($errors->has('meta_title') ? 'has-danger' : ''); ?>"> 
                            ...
                            <?php echo Form::text('meta_title', $post->meta->meta_title??'', array('class' => 'form-control m-input', 'id'=>'meta_title')); ?> 
                    ...
                    <div class="col-md-12">
                        <div class="form-group <?php echo e($errors->has('meta_key') ? 'has-danger' : ''); ?>"> 
                            ...
                            <?php echo Form::text('meta_key',  $post->meta->meta_key??'', array('class' => 'form-control m-input', 'id'=>'meta_key')); ?> 
                ...
                <div class="form-group <?php echo e($errors->has('meta_description') ? 'has-danger' : ''); ?>"> 
                    ...
                    <?php echo Form::textarea('meta_description', $post->meta->meta_description??'', array('class' => 'form-control m-input',  'rows'=>'2', 'id'=>'meta_description')); ?> 
        ...
        <div class="m-portlet m-portlet--tab mb10">
            ...
            <div class="m-portlet__body right-bar">  
                <div class="form-group">
                    ...
                    <?php echo Form::select('category',$allCategories??[], $post->category??old('category'), ['class'=>'form-control c_selectpicker m-input', 'placeholder'=>'Kategorie wählen', 'data-rel'=>'chosen']); ?> 
                </div>  

                <div class="form-group">
                    <label for="template">Post-Format</label>
                    <?php echo Form::select('template',$templates??[], $post->post_template??old('post_template'), ['class'=>'form-control c_selectpicker m-input', 'data-rel'=>'chosen']); ?> 
                </div>  

                <div class="form-group">
                    <label for="status">Status</label>
                    <?php echo Form::select('status', ['Active'=>'Aktiv', 'Inactive'=>'Inaktiv'], $post->status??old('status'), ['class'=>'form-control c_selectpicker m-input', 'data-rel'=>'chosen']); ?> 
                </div> 
                    ...
                    <div class="form-group m-form__group <?php echo e($errors->has('picture') ? 'has-danger' : ''); ?>">  
                        <button id="lfm" data-input="mediaThumbnail" data-preview="mediaHolder" class="img-brows"> 
                            <div class="holder" id="mediaHolder"> 
                                <img src="<?php echo e($post->picture?? URL::to('images/default.jpg')); ?>">
                            </div>
                            <input id="mediaThumbnail" hidden="" value="<?php echo e($post->picture?? URL::to('images/default.jpg')); ?>" type="text" name="picture">
                        </button>  
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app-backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\bdrentz\resources\views/backend/quotation/create.blade.php ENDPATH**/ ?>