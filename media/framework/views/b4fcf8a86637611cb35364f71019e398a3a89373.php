                            ...
                            <span class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('post-edit')): ?>
                                        <a class="dropdown-item" href="<?php echo e(route('posts.edit',$post->id)); ?>"><i class="la la-edit"></i> Edit </a>
                                    <?php endif; ?>
                                    
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('post-delete')): ?>
                                        

                                    <a class="dropdown-item" href="#<?php echo e(route('posts.destroy', $post->id)); ?>"
                                        onclick="event.preventDefault(); document.getElementById('delete-form<?php echo e($post->id); ?>').submit();
                                    "><i class="la la-trash"></i>Delete</a>
                                    <?php echo Form::open(['method' => 'DELETE','route' => ['posts.destroy', $post->id],'style'=>'display:inline', 'id'=>'delete-form'.$post->id]); ?>
...
<?php echo $__env->make('layouts.app-backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\bdrentz\resources\views/backend/posts/list.blade.php ENDPATH**/ ?>