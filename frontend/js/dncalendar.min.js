...
var headerGroup=$("<div id='dncalendar-header' class='dncalendar-header'></div>");headerGroup.append("<h2>"+headerMonth+" <br> "+y+"</h2>");var prevInactive=!1;var minDate=null;if(typeof settings.minDate!=='undefined'){var minDateArr=settings.minDate.split('-');minDate=new Date(minDateArr[0],minDateArr[1]-1,minDateArr[2]);if(minDate.getFullYear()>=y){if(minDate.getMonth()>=m){prevInactive=!0}}}
...
var calendarLinksGroup=$("<div id='dncalendar-links' class='dncalendar-links'></div>");var prevLinkGroup=$("<div id='dncalendar-prev-month' class='dncalendar-prev-month'><i class='fa fa-angle-left'></i>  Zurück</div>");var nextLinkGroup=$("<div id='dncalendar-next-month' class='dncalendar-next-month'> Vor <i class='fa fa-angle-right'></i>  </div>");if(prevInactive){prevLinkGroup.addClass("dncalendar-inactive");prevLinkGroup.removeAttr("id")}
